...
<html lang="ko">
    <head>
        ...
        <style>
        	.btn{border: 1px solid #333;    border-radius: 3px;    padding: 1px 8px;    margin-left: 2px;    background-color: transparent;}.fUploadDiv ul li{margin-right:15px;}
    ...
    <body>
             ...
             <form role='form' method="post" action="/board/update">
            	<div>
		            <div>
		            	 ...
		            	 <table>
		            	 	<tr><th class="private" style="width: 10%;display:none;">카테고리</th><th class="public" style="width: 3%;">카테고리</th>
		            	 				<td class="private"  colspan='3' style="display:none;">
						            	 	<input type="hidden" id="writer" value="${update.writer}">
		            	 	...
		            	 	<td  class="public" style="width: 30%;" colspan='3'><input name="cate" value='${update.cate}' style="outline:none;" readonly="readonly"><span style="position: absolute;top: 12px;left: 25px;">등급</span></td>
		            	 	</tr>
		            	 	<tr class="private" style="display:none;">
		            	 	<th>게시일</th>
		            	 		<td colspan='3'> 
		            	 			<div class="tui">
		            	 				<input type="hidden" name="updateDate" value="" style="outline:none;" readonly="readonly">
			                            <div class="tui-box">
		            	 	...
		            	 	<tr style="display:none;"><td><input type="hidden" name="bno" id="bno"  value='${update.bno}' ><input type="hidden" id="uCate"  value='${update.cate}' ></td></tr>
		            	 	<tr>
		            	 		<th>제목</th>
	            	 			<td colspan='3'>
		            	 			<div  style="display:flex;" >
			            	 			<input type="text" id="title" name="title" value="${update.title}" style="outline:none;width: 600px;border: 1px solid #ababab;" placeholder="제목을 입력해주세요." />  
			            	 			<input type="hidden" id="pin" value="${update.pin}" />  
			            	 			<span class="private" style="display:none;margin-left:10px;">
		 					 ...
		 					 <tr>
			            	 	 ...
			            	 	 <td colspan='3'>
				            	 	 <div class='fUploadDiv'>
					            	 	 <input type="file" id="fUploadFile" name="fUploadFile" style="display:none;">
		            	 	 ...
		            	 	 <tr>
			            	 	 ...
			            	 	 <td colspan='3'>
				            	 	 <div class='sUploadDiv'>
					            	 	 <input type="file" id="sUploadFile" name="sUploadFile" style="display:none;">
	                    ...
	                    <button type="submit" class="button modify" id="button" style="position:absolute;bottom:-30px;right: 80px;" onclick="save()">등록</button>
        ...
        <script>
        if($("#writer").val()=="관리자"){
        $("#cate").val($("#uCate").val()).prop("selected", true);
       	$(".private").css('display','');
        ...
        $("#button").click(function(e){
	           ...
	           var nowDate;
	 		   var boardDate=$("input[name='updateDate']")
